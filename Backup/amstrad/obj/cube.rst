...
Hexadecimal [16-Bits]
                              ...
                              4 
                              5 
   40D6                       6 DefineCubeLine1 cubeline10, 0x00, 0x100, 0x04, 0x08, 0x01, 0x0F
   0000                       1 cubeline10:
   40D6 00 00                 2     .db     0x00, 0x100  ;; X, Y
   40D8 04 08                 3     .db     0x04, 0x08  ;; W, H
   40DA 01                    4     .db     0x01     ;; Hitpoints
   40DB 0F                    5     .db     0x0F    ;; Color
   40DC                       7 DefineCubeLine1 cubeline11, 0x04, 0x100, 0x04, 0x08, 0x01, 0xFF
   0006                       1 cubeline11:
   40DC 04 00                 2     .db     0x04, 0x100  ;; X, Y
   40DE 04 08                 3     .db     0x04, 0x08  ;; W, H
   40E0 01                    4     .db     0x01     ;; Hitpoints
   40E1 FF                    5     .db     0xFF    ;; Color
   40E2                       8 DefineCubeLine1 cubeline12, 0x08, 0x100, 0x04, 0x08, 0x01, 0x0F
   000C                       1 cubeline12:
   40E2 08 00                 2     .db     0x08, 0x100  ;; X, Y
   40E4 04 08                 3     .db     0x04, 0x08  ;; W, H
   40E6 01                    4     .db     0x01     ;; Hitpoints
   40E7 0F                    5     .db     0x0F    ;; Color
   40E8                       9 DefineCubeLine1 cubeline13, 0x0C, 0x100, 0x04, 0x08, 0x01, 0xFF
   0012                       1 cubeline13:
   40E8 0C 00                 2     .db     0x0C, 0x100  ;; X, Y
   40EA 04 08                 3     .db     0x04, 0x08  ;; W, H
   40EC 01                    4     .db     0x01     ;; Hitpoints
   40ED FF                    5     .db     0xFF    ;; Color
   40EE                      10 DefineCubeLine1 cubeline14, 0x10, 0x100, 0x04, 0x08, 0x01, 0x0F
   0018                       1 cubeline14:
   40EE 10 00                 2     .db     0x10, 0x100  ;; X, Y
   40F0 04 08                 3     .db     0x04, 0x08  ;; W, H
   40F2 01                    4     .db     0x01     ;; Hitpoints
   40F3 0F                    5     .db     0x0F    ;; Color
   40F4                      11 DefineCubeLine1 cubeline15, 0x14, 0x100, 0x04, 0x08, 0x01, 0xFF
   001E                       1 cubeline15:
   40F4 14 00                 2     .db     0x14, 0x100  ;; X, Y
   40F6 04 08                 3     .db     0x04, 0x08  ;; W, H
   40F8 01                    4     .db     0x01     ;; Hitpoints
   40F9 FF                    5     .db     0xFF    ;; Color
   40FA                      12 DefineCubeLine1 cubeline16, 0x18, 0x100, 0x04, 0x08, 0x01, 0x0F
   0024                       1 cubeline16:
   40FA 18 00                 2     .db     0x18, 0x100  ;; X, Y
   40FC 04 08                 3     .db     0x04, 0x08  ;; W, H
   40FE 01                    4     .db     0x01     ;; Hitpoints
   40FF 0F                    5     .db     0x0F    ;; Color
   4100                      13 DefineCubeLine1 cubeline17, 0x1C, 0x100, 0x04, 0x08, 0x01, 0xFF
   002A                       1 cubeline17:
   4100 1C 00                 2     .db     0x1C, 0x100  ;; X, Y
   4102 04 08                 3     .db     0x04, 0x08  ;; W, H
   4104 01                    4     .db     0x01     ;; Hitpoints
   4105 FF                    5     .db     0xFF    ;; Color
   4106                      14 DefineCubeLine1 cubeline18, 0x20, 0x100, 0x04, 0x08, 0x01, 0x0F
   0030                       1 cubeline18:
   4106 20 00                 2     .db     0x20, 0x100  ;; X, Y
   4108 04 08                 3     .db     0x04, 0x08  ;; W, H
   410A 01                    4     .db     0x01     ;; Hitpoints
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 53.
Hexadecimal [16-Bits]



   410B 0F                    5     .db     0x0F    ;; Color
   410C                      15 DefineCubeLine1 cubeline19, 0x24, 0x100, 0x04, 0x08, 0x01, 0xFF
   0036                       1 cubeline19:
   410C 24 00                 2     .db     0x24, 0x100  ;; X, Y
   410E 04 08                 3     .db     0x04, 0x08  ;; W, H
   4110 01                    4     .db     0x01     ;; Hitpoints
   4111 FF                    5     .db     0xFF    ;; Color
   4112                      16 DefineCubeLine1 cubeline110, 0x28, 0x100, 0x04, 0x08, 0x01, 0x0F
   003C                       1 cubeline110:
   4112 28 00                 2     .db     0x28, 0x100  ;; X, Y
   4114 04 08                 3     .db     0x04, 0x08  ;; W, H
   4116 01                    4     .db     0x01     ;; Hitpoints
   4117 0F                    5     .db     0x0F    ;; Color
   4118                      17 DefineCubeLine1 cubeline111, 0x2C, 0x100, 0x04, 0x08, 0x01, 0xFF
   0042                       1 cubeline111:
   4118 2C 00                 2     .db     0x2C, 0x100  ;; X, Y
   411A 04 08                 3     .db     0x04, 0x08  ;; W, H
   411C 01                    4     .db     0x01     ;; Hitpoints
   411D FF                    5     .db     0xFF    ;; Color
   411E                      18 DefineCubeLine1 cubeline112, 0x30, 0x100, 0x04, 0x08, 0x01, 0x0F
   0048                       1 cubeline112:
   411E 30 00                 2     .db     0x30, 0x100  ;; X, Y
   4120 04 08                 3     .db     0x04, 0x08  ;; W, H
   4122 01                    4     .db     0x01     ;; Hitpoints
   4123 0F                    5     .db     0x0F    ;; Color
   4124                      19 DefineCubeLine1 cubeline113, 0x34, 0x100, 0x04, 0x08, 0x01, 0xFF
   004E                       1 cubeline113:
   4124 34 00                 2     .db     0x34, 0x100  ;; X, Y
   4126 04 08                 3     .db     0x04, 0x08  ;; W, H
   4128 01                    4     .db     0x01     ;; Hitpoints
   4129 FF                    5     .db     0xFF    ;; Color
   412A                      20 DefineCubeLine1 cubeline114, 0x38, 0x100, 0x04, 0x08, 0x01, 0x0F
   0054                       1 cubeline114:
   412A 38 00                 2     .db     0x38, 0x100  ;; X, Y
   412C 04 08                 3     .db     0x04, 0x08  ;; W, H
   412E 01                    4     .db     0x01     ;; Hitpoints
   412F 0F                    5     .db     0x0F    ;; Color
   4130                      21 DefineCubeLine1 cubeline115, 0x3C, 0x100, 0x04, 0x08, 0x01, 0xFF
   005A                       1 cubeline115:
   4130 3C 00                 2     .db     0x3C, 0x100  ;; X, Y
   4132 04 08                 3     .db     0x04, 0x08  ;; W, H
   4134 01                    4     .db     0x01     ;; Hitpoints
   4135 FF                    5     .db     0xFF    ;; Color
   4136                      22 DefineCubeLine1 cubeline116, 0x40, 0x100, 0x04, 0x08, 0x01, 0x0F
   0060                       1 cubeline116:
   4136 40 00                 2     .db     0x40, 0x100  ;; X, Y
   4138 04 08                 3     .db     0x04, 0x08  ;; W, H
   413A 01                    4     .db     0x01     ;; Hitpoints
   413B 0F                    5     .db     0x0F    ;; Color
   413C                      23 DefineCubeLine1 cubeline117, 0x44, 0x100, 0x04, 0x08, 0x01, 0xFF
   0066                       1 cubeline117:
   413C 44 00                 2     .db     0x44, 0x100  ;; X, Y
   413E 04 08                 3     .db     0x04, 0x08  ;; W, H
   4140 01                    4     .db     0x01     ;; Hitpoints
   4141 FF                    5     .db     0xFF    ;; Color
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 54.
Hexadecimal [16-Bits]



   4142                      24 DefineCubeLine1 cubeline118, 0x48, 0x100, 0x04, 0x08, 0x01, 0x0F
   006C                       1 cubeline118:
   4142 48 00                 2     .db     0x48, 0x100  ;; X, Y
   4144 04 08                 3     .db     0x04, 0x08  ;; W, H
   4146 01                    4     .db     0x01     ;; Hitpoints
   4147 0F                    5     .db     0x0F    ;; Color
   4148                      25 DefineCubeLine1 cubeline119, 0x4C, 0x100, 0x04, 0x08, 0x01, 0xFF
   0072                       1 cubeline119:
   4148 4C 00                 2     .db     0x4C, 0x100  ;; X, Y
   414A 04 08                 3     .db     0x04, 0x08  ;; W, H
   414C 01                    4     .db     0x01     ;; Hitpoints
   414D FF                    5     .db     0xFF    ;; Color
                             26 
                             27 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                             28 ;; DRAW ENTITY
                             29 ;; REGISTERS DETROYED: AF, BC, DE ,HL
                             30 ;; INPUT: IX -> Points to entity
                             31 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
   414E                      32 cube_draw:
   414E 11 00 C0      [10]   33     ld    de, #0xC000       ;;Comienzo memoria de video
   4151 DD 4E 00      [19]   34     ld     c, c_x(ix)         ;; C = Entity Y
   4154 DD 46 01      [19]   35     ld     b, c_y(ix)         ;; B = Entity X
   4157 CD 60 42      [17]   36     call cpct_getScreenPtr_asm
                             37 
   415A EB            [ 4]   38     ex    de, hl        ;; DE = Puntero a memoria
   415B DD 7E 05      [19]   39     ld  a, c_col(ix)    ;; Color
   415E DD 46 03      [19]   40     ld  b, c_h(ix)      ;; Alto
   4161 DD 4E 02      [19]   41     ld  c, c_w(ix)      ;; Ancho
                             42 
   4164 CD B3 41      [17]   43     call cpct_drawSolidBox_asm
                             44 
   4167 C9            [10]   45     ret
                             46 
                             47 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                             48 ;; BORRA UNA ENTIDAD
                             49 ;; PARA CUADRADOS UNICAMENTE
                             50 ;; REGISTERS DESTROYED: AF, AF', BC, DE, HL
                             51 ;; ENTRADA: IX -> Puntero a entidad
                             52 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
   4168                      53 cube_clear:
                             54 
   4168 DD 7E 05      [19]   55    ld  a, c_col(ix)
   416B 08            [ 4]   56    ex af, af'
                             57 
   416C DD 36 05 00   [19]   58    ld  c_col(ix), #0
                             59 
   4170 CD 4E 41      [17]   60    call cube_draw
   4173 08            [ 4]   61    ex af, af'
   4174 DD 77 05      [19]   62    ld c_col(ix), a
                             63 
   4177 C9            [10]   64    ret
